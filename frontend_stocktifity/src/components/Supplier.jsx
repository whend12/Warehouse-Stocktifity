  ...
  let {
    ...
    return (
                        ...
                        <div className="w-full sm:-mx-6 lg:-mx-8 bg-[#ffffff] rounded-lg">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <div className="btn-create">
                                <button onClick={()=> setShowModal(true)} className="flex items-center w-[6rem] bg-[#03C988] text-white mr-8 p-1 rounded hover:bg-[#03C4A1] focus:outline-none">
                                  <AiFillPlusSquare size={21} color={"white"} className="mr-2"/>Create
                                </button>
                              </div>
                            </div>
                            ...
                            <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                              ...
                              <div className="flex flex-col items-center w-full px-4 py-2 space-y-2 text-sm text-gray-500 sm:justify-between sm:space-y-0 sm:flex-row">
                                  <p className="flex">Showing&nbsp;<span className="font-bold"> 1 to 5 </span>&nbsp;of 5 entries</p>
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                  ...
                  <button onClick={() => setShowModal (false)} className="w-1 shadow-none focus:outline-none"><ImCancelCircle fill="#D61355"/></button>
                </div>
                  ...
                  <form onSubmit={handleSubmit} className="bg-white rounded-md w-50">
                    <div className="w-full sm:flex items-center">
                      ...
                      <div className="w-full sm:w-1/2 pl-4 pr-4">
                        <input onChange={handleInput} value={input.name} maxLength={20} type="text" id="name" name="name" placeholder="Input name" className="block w-full border-b-2 border-[#6B728E] text-sm pl-2 rounded-md shadow-none focus:bg-[#E4E4E4] focus:border-[#404258] focus:text-black outline-none" required></input>
                      </div>        
                    </div>
                    <div className="w-full sm:flex items-center">
                      <div className="w-full sm:w-1/3">
                      ...
                      <div className="w-full sm:w-1/2 pl-4 pr-4">
                        <input onChange={handleInput} value={input.email} type="email" id="email" name="email" placeholder="Example@example.com" className="block w-full border-b-2 border-[#6B728E] text-sm pl-2 rounded-md shadow-none focus:bg-[#E4E4E4] focus:border-[#404258] focus:text-black outline-none" required></input>
                      </div>        
                    </div>
                    <div className="w-full sm:flex items-center">
                      <div className="w-full sm:w-1/3">
                      ...
                      <div className="w-full sm:w-1/2 pl-4 pr-4">
                        <input onChange={handleInput} value={input.phone} maxLength={8} type="number" name="phone" id="phone" placeholder="628987654888" className="block w-full border-b-2 border-[#6B728E] text-sm pl-2 rounded-md shadow-none focus:bg-[#E4E4E4] focus:border-[#404258] focus:text-black outline-none" required></input>
                      </div>        
                    </div>
                    <div className="w-full sm:flex items-center">
                      <div className="w-full sm:w-1/3">
                      ...
                      <div className="w-full sm:w-1/2 pl-4 pr-4">
                        <input onChange={handleInput} value={input.address} maxLength={50} type="text" name="address" id="address" placeholder="Input address" className="block w-full border-b-2 border-[#6B728E] text-sm pl-2 rounded-md shadow-none focus:bg-[#E4E4E4] focus:border-[#404258] focus:text-black outline-none" required></input>
                      </div>        
                    </div>
        ...
        <Alert severity="warning">
          ...
          <DialogActions>
            <button onClick={handleClose} className="bg-[#EB455F] rounded hover:bg-[#C92C6D] focus:outline-none">Yes</button>
            <button onClick={handleClose} className="bg-[#FFED00] rounded hover:bg-[#F9F54B] focus:outline-none">No</button>
          </DialogActions>
        </Dialog>
        </>
    )
