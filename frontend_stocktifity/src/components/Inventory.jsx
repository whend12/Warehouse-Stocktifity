                ...
                <div className="relative flex-auto">
                  <form onSubmit={handleSubmit} className="bg-white rounded-md w-50">
                    ...
                    <div className="w-full sm:flex items-center">
                      ...
                      <div className="w-full sm:w-1/2 pl-4 pr-4">
                        <input onChange={handleInput} value={input.sku} maxLength={8} type="text" id="sku" name="sku" placeholder="A001" className="block w-full border-b-2 border-[#6B728E] text-sm pl-2 rounded-md shadow-none focus:bg-[#E4E4E4] focus:border-[#404258] focus:text-black outline-none" required></input>
                      </div>        
                    </div>
                    <div className="w-full sm:flex items-center">
                      <div className="w-full sm:w-1/3">
                      ...
                      <div className="w-full sm:w-1/2 pl-4 pr-4">
                        <input onChange={handleInput} value={input.category} maxLength={20} type="text" id="category" name="category" placeholder="Input category" className="block w-full border-b-2 border-[#6B728E] text-sm pl-2 rounded-md shadow-none focus:bg-[#E4E4E4] focus:border-[#404258] focus:text-black outline-none" required></input>
                      </div>        
                    </div>
